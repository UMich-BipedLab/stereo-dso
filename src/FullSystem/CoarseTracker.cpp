...
namespace dso
{
  ...
  // compute hessian, jacobian, huber weight 
  ...
  /* level, relative pose, light, the threshold that we should just use a
   * pre-defined max energy for this point
   */
  ...
  bool CoarseTracker::trackNewestCoarse(// current frame
                                        FrameHessian* newFrameHessian,
                                        // output last2curr transformation
                                        SE3 &lastToNew_out,
                                        // output relative change of illumination
                                        AffLight &aff_g2l_out,
                                        // number of levels of pyramids
                                        int coarsestLvl,
                                        ...
                                        IOWrap::Output3DWrapper* wrap)
  {
    ...
    for(int lvl=coarsestLvl; lvl>=0; lvl--)
    {
      ...
      // calculate residual for each pyramid
      ...
      // compute hessian, jacobian in G-N updates
      ...
      // the last residual is obtained from calcRes
